<template>
  ...
  const modelDetailData = ref<ModelDetailData>({
    ...
    score: {
      "GPT4o": { total_questions: 36, score_total: 0.593 },
      "Doubao-pro": { total_questions: 36, score_total: 0.481 },
      "Deepseek-v2.5": { total_questions: 36, score_total: 0.545 },
      "Qwen-max": { total_questions: 100, score_total: 0.499 },
      "GLM-4": { total_questions: 36, score_total: 0.461 },
      "Baichuan-4": { total_questions: 36, score_total: 0.305 },
      "ERNIE-4": { total_questions: 36, score_total: 0.386 },
      "Yi-large": { total_questions: 36, score_total: 0.410 }
    }
  });
